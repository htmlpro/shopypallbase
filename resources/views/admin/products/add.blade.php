...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-arrow-left back__arrow" aria-hidden="true"></i> {{ trans('labels.AddNewProduct') }} </h3>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label qq">{{ trans('labels.Product Type') }}<span style="color:red;">*</span></label>
        ...
        <!-- /.row -->
                        ...
                        <h3 class="box-title"><i class="fa fa-arrow-left back__arrow" aria-hidden="true"></i><span class="sapan_cls"></span> Add New Products</h3>
                    </div><br/>
                    <div class="">
                    <div class="row">
                            <div class="col-xs-12">
                         ...
                         <div class="row margin-0">
                             <div class="col-lg-8 col-md-8 col-12 first____sec">
                                 <div class="row">
                             <div class="form-group">
                                    <label for="name" class="col-sm-2 col-md-2 control-label">product type<span style="color:red;">*</span></label>
                        ...
                        <br/> 
                        <span><i class="fa fa-search my____search11" aria-hidden="true"></i></span>    <input type="search" id="" placeholder="search the collections" class="search___filed" />
                        <p class="search__para">Add this product to a collection so it’s easy<br/> to find in your store.</p>
                        <hr class="w-100"/>
                        <h5>TAGS</h5>
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        ...
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                        Choose if this is in deals/special products. Special<br/> products belongs to deals.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                       ...
                                                       <div class="vbbv">
                                                        <div id="imageselected ">
                                                          ...
                                                          <div class="closimage ">
                                                              <button type="button" class="close pull-left image-close " id="image-close"
                                                                style="display: none; position: absolute;left: 110px; top: 54px; background-color: black; color: white; opacity: 2.2; " aria-label="Close">
                                                                  <span aria-hidden="true">&times;</span>
                                                              </button>
                                                          </div>
                                                        </div>
